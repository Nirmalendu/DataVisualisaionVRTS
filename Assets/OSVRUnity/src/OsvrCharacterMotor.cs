    ...
    namespace Unity
    {
        ...
        public class OsvrCharacterMotor : MonoBehaviour
        {
            ...
            public class OsvrCharacterMotorMovement
            {
                ...
                public float maxSidewaysSpeed = 50.0f;
                public float maxBackwardsSpeed = 50.0f;
            ...
            private Vector3 ApplyGravityAndJumping(Vector3 velocity)
            {
                ...
                if (jumping.enabled)
                {
                    ...
                    Vector3 flyingMoveDirection = new Vector3(0, Input.GetAxis("Mouse ScrollWheel") * 15000.0F, 0);                                 
                    Vector3 flyingMoveDirectionneg = new Vector3(0, Input.GetAxis("Sprint") * -40.0F, 0);
                    controller.Move(flyingMoveDirectionneg * Time.deltaTime);
